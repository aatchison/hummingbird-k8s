...
| Phase 1B — `update-cluster` (live-execution slice; cycle 1 = `cp_kubectl` + drain/uncordon; cycle 2 = bootID gate; cycle 3 = DaemonSet-ready gate) | [#322](https://github.com/aatchison/hummingbird-k8s/issues/322) | cycles 1 (PR #325) + 2 (PR #344) + 3 (#328 / PR #346) landed; cycle 4 ([#329](https://github.com/aatchison/hummingbird-k8s/issues/329)) pending |
