...
setup() {
  ...
  unset CONFIG FLAGS AUTO_UPDATE_CP SWITCH_TO_GHCR \
        ...
        IMAGE_SOURCE GHCR_ORG GHCR_TAG BOOTC_SWITCH_TO_GHCR STRICT_CACHE \
...
@test "ssh-wrap: HBIRD_SSH_WRAP_ALLOWED_ENV pins the exact allowlist set" {
  ...
  expected=(
    ...
    VM_USER VM_USER_GROUPS BASE_IMAGE BIB ENABLE_ROOT_SSH
    STORAGE_DRIVER PODMAN_ROOT PODMAN_RUNROOT APISERVER_EXTRA_SANS
